...
export const attractions: Attraction[] = [
  ...
  // ============================================
  {
    ...
    relatedPages: ['/things-to-do/history-culture', '/itineraries/family-day', '/itineraries/history-and-wine'],
  ...
  },
  {
    ...
    relatedPages: ['/things-to-do/history-culture', '/itineraries/history-and-wine'],
    imageId: 'historic-placer-courthouse',
  ...
  },
  {
    ...
    locationArea: 'old-town',
    relatedPages: ['/things-to-do/history-culture', '/itineraries/weekend-in-auburn'],
  ...
  },
  {
    ...
    locationArea: 'old-town',
    relatedPages: ['/things-to-do/history-culture'],
